...
public class Batalla {
    ...
    public void generarPokemon1(){
        ...
        System.out.println("Player 1 elige a tu pokemon:");
        player1.generarPokemon(auxiliar1);
    ...
    public void generarPokemon2(){
        ...
        System.out.println("Player 2 elige a tu pokemon:");
        player2.generarPokemon(auxiliar2);
    ...
    public void batalla(){
        ...
        System.out.println("Que empiece la pelea entre: " + player1.getNombre() + " vs " + player2.getNombre() + "\n");
        do{
