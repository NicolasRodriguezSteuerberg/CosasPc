...
select area.coda,count(codm) from area left join adscrito on area.coda=adscrito.coda group by area.coda; (el bueno) 
...
select codp,numas from hosp1 where datai<='23/03/2017' and dataf>='10/02/2016';
