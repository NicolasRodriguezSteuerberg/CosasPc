...
drop table if exists  dirixe cascade ;
...
nomed varchar(20),
nsocio integer ,
primary key (nomed,nsocio),
foreign key (nomed) references departamento(nomed),
foreign key (nsocio) references profesor(nsocio)
);
--
--
...
-- insercions feitas en xaneio de 2021
insert into autor values('a17','Robin Lane');
insert into autor values('a18','Fedor Dostoievski');


-- libro
-- clibro | titulo | editorial | dedicion | nexemplares | autor
insert into libro values('c1','o asno de oro','catedra','10/1/2004',4,20,'a14' );
insert into libro values('c2','apoloxia','catedra','30/1/2004',2,15,'a14' );
insert into libro values('c3','o arrincacorazons','alianza','20/1/2004',3,15,'a15' );
insert into libro values('c4','a espuma dos dias','alianza','20/6/2004',3,30,'a15' );
insert into libro values('c5','matematica1','planeta','1/2/2004',1,20,'a13' );
insert into libro values('c6','yerma','alianza','10/2/2004',2,null,'a8' );
insert into libro values('c7','la casa de bernarda alba','anagrama','1/2/2004',2,null,'a8' );
insert into libro values('c8','teorema','anaya','11/2/2004',1,null,'a11' );
insert into libro values('c9','os papuyos','alianza','10/2/2004',1,20,'a4' );
insert into libro values('c10','don quijote de la mancha','catedra','10/2/2004',2,null,'a1' );
insert into libro values('c11','o espacio valeiro','alianza','10/2/2004',1,null,'a3' );
insert into libro values('c12','mc2','catedra','1/2/2004',1,10,'a7' );
insert into libro values('c13','o princinho','alianza','10/2/2004',1,20,'a12' );
insert into libro values('c14','fisica cuantica','alianza','10/2/2004',1,null,'a7' );
insert into libro values('c15','transformadas de fourier','anaya','10/2/2004',1,null,'a16' );
insert into libro values('c16','matematica2','planeta','10/2/2004',2,30,'a13' );
insert into libro values('c17','simbolismo','tusquets','10/2/2009',1,null,'a10' );
-- insercions feitas en xaneiro 2021
insert into libro values('c18','os hirmans karamazof','sopena','10/2/1958',1,null,null );
insert into libro values('c19','the unauthorized version','viking','10/2/1991',1,null,null );
