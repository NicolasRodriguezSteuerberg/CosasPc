...
drop table if exists tratado cascade  ;
drop table if exists compon cascade  ;
drop table if exists ten cascade  ;
drop table if exists ataca cascade  ;
drop table if exists sulfato cascade  ;
drop table if exists fungicida cascade  ;
drop table if exists fungo cascade  ;
drop table if exists operario cascade  ;
drop table if exists cepa cascade  ;
drop table if exists vinhedo cascade  ;
drop table if exists viticultor cascade  ;
