...
/*
procedimiento chamado p14_colexiadopartidos que amose para cada colexiado o nome e as datas dos partidos nos que interven
*/
CREATE or replace procedure p14_colexiadopartidos()
    LANGUAGE PLPGSQL
    AS
$$
DECLARE
