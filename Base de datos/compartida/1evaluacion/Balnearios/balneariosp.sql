...
drop table if exists prescriben cascade;
drop table if exists asignan cascade ;
drop table if exists cat2 cascade ;
drop table if exists cat1 cascade ;
drop table if exists ten cascade ;
drop table if exists balnearios cascade ;
drop table if exists medicos cascade ;
drop table if exists agudos cascade ;
drop table if exists cronicos cascade ;
drop table if exists aloxan cascade ;
drop table if exists habitacions cascade ;
drop table if exists hoteis cascade ;
drop table if exists padecen cascade ;
drop table if exists pacientes cascade ;
drop table if exists poboacions cascade ;
drop table if exists indicadas cascade ;
drop table if exists zonas_corporais cascade ;
drop table if exists compon cascade ;
drop table if exists augas cascade ;
drop table if exists minerais cascade ;
...
insert into aloxan values ('361','h1',1,'7/5/2019','17/5/2019');
insert into aloxan values ('362','h4',2,'9/6/2019','15/6/2019');
insert into aloxan values ('364','h5',1,'13/8/2019','23/8/2019');
insert into aloxan values ('361','h1',2,'6/6/2020','17/6/2020');
insert into aloxan values ('364','h3',1,'10/9/2019','20/9/2019');
insert into aloxan values ('365','h3',1,'21/4/2019','30/4/2019');
insert into aloxan values ('366','h4',2,'12/11/2019','22/11/2019');
insert into aloxan values ('362','h4',3,'10/7/2020','19/7/2020');

insert into aloxan values ('3612','h4',1,'15/7/2020','25/7/2020');
insert into aloxan values ('3612','h1',1,'2/7/2020','12/7/2020');
insert into aloxan values ('3613','h3',1,'13/7/2020','23/7/2020');
insert into aloxan values ('3614','h4',3,'10/9/2020','20/9/2020');
insert into aloxan values ('3615','h2',1,'1/7/2020','10/7/2020');
insert into aloxan values ('3615','h4',3,'12/11/2020','22/11/2020');
...
insert into asignan values ('361','b1','m1','8/5/2019','17/5/2019');
insert into asignan values ('362','b2','m1','10/6/2019','15/6/2019');
insert into asignan values ('364','b3','m2','14/8/2019','23/8/2019');
insert into asignan values ('361','b4','m2','7/6/2020','17/6/13');
insert into asignan values ('364','b4','m2','11/9/2019','20/9/2019');
insert into asignan values ('365','b4','m4','22/4/2019','30/4/2019');
insert into asignan values ('366','b5','m4','13/11/2019','22/11/2019');
insert into asignan values ('362','b4','m5','11/7/2020','20/7/2020');
...
insert into prescriben values ('3612','b6','m1','16/7/2020','25/7/2020');
insert into prescriben values ('3612','b6','m3','3/7/2020','12/7/2020');
insert into prescriben values ('3613','b7','m4','14/7/2020','23/7/2020');
insert into prescriben values ('3614','b7','m4','11/9/2020','20/9/2020');
insert into prescriben values ('3615','b9','m5','2/7/2020','10/7/2020');
insert into prescriben values ('3615','b6','m5','13/11/2020','22/11/2020');
