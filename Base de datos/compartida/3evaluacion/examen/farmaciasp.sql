...
drop table if exists traballan cascade ;
drop table if exists persoas CASCADE ;
drop table if exists stock CASCADE ;
drop table if exists componen CASCADE ;
...
drop table if exists presentacions CASCADE ;
drop table if exists propios CASCADE ;
drop table if exists farmaceuticos CASCADE ;
...
CREATE TABLE medicamentos (
    ...
    FOREIGN KEY (cif) REFERENCES laboratorios(cif)
);
...
CREATE TABLE componen (
    ...
    FOREIGN KEY (codc) REFERENCES componentes(codc),
    FOREIGN KEY (codm) REFERENCES medicamentos(codm)
);
...
CREATE TABLE stock (
    ...
    FOREIGN KEY (codm) REFERENCES medicamentos(codm),
    FOREIGN KEY (codpre) REFERENCES presentacions(codpre)
);
...
insert into medicamentos values(1,'feparil','b361',1,7);
insert into medicamentos values(2,'ibuprofenour','b362',8,5);
insert into medicamentos values(3,'axiago','b363',2,4);
insert into medicamentos values(4,'norflox','b364',3,null);
insert into medicamentos values(5,'eferalgan','b365',4,null);
insert into medicamentos values(6,'flumil','b367',5,6);
insert into medicamentos values(7,'omeprazollab','b368',7,10);
insert into medicamentos values(8,'omeprazolmerc','b366',7,null);
insert into medicamentos values(9,'ibuprofenoest','b368',8,4);
insert into medicamentos values(10,'feldegel','b363',3,6);
insert into medicamentos values(11,'eyexmax','b365',9,10);
insert into medicamentos values(12,'ortil','b365',7,20);
insert into medicamentos values(13,'romuol','b363',7,15);
